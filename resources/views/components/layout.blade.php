                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <x-nav-link href='/' :active="request()->is('/')" id="home">
                                    Home
                                </x-nav-link>
                                <x-nav-link href='/jobs' :active="request()->is('jobs')" id="jobs">
                                    jobs
                                </x-nav-link>
                                <x-nav-link href='/contact' :active="request()->is('contact')" id="contact">
                                    contact
                                </x-nav-link>
                            </div>
                        </div>
